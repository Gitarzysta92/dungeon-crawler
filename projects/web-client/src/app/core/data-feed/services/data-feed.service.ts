...
import { IAdventureGameplayTemplate } from "@game-logic/gameplay/modules/adventure/adventure.interface";
...
import { IDungeonTemplateDeclaration } from "@game-logic/gameplay/modules/dungeon/entities/dungeon-area/dungeon-area.interface";
...
export class DataFeedService implements IAdventureGameplayFeed, IDungeonGameplayFeed {
  ...
  public async getDungeonTemplates(ids?: string[] | undefined) {
    return this._getListData<IDungeonTemplateDeclaration>(DUNGEON_TEMPLATES_DATA_FEED_KEY, ids);
  }

  public async getDungeonTemplate(id: string) {
    return this._indexedDbService.read<IDungeonTemplateDeclaration>(id, DUNGEON_TEMPLATES_DATA_FEED_KEY);
  }
  ...
  public async getAdventureGameplayTemplate() {
    return this._indexedDbService.read<IAdventureGameplayTemplate>("", ADVENTURE_TEMPLATE_DATA_FEED_KEY);
  }
