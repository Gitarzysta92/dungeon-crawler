...
export class OriginPickerComponent implements OnInit, OnDestroy {
  ...
  public origins: Array<IHeroOriginDeclaration & INarrativeMedium & IUiMedium>;
  public selectedOrigin: IHeroOriginDeclaration & INarrativeMedium & IUiMedium;
  public previewOrigin: IHeroOriginDeclaration & INarrativeMedium & IUiMedium;
  ...
  ngOnInit(): void {
    this._gameBuilderStateStore.state$
      ...
      .subscribe(s => {
        ...
        this.origins = this.step.items as unknown as Array<IHeroOriginDeclaration & INarrativeMedium & IUiMedium>;
        this.previewOrigin = this.step.selectedItem as any ?? this.origins[0];
        this.selectedOrigin = this.step.selectedItem as unknown as IHeroOriginDeclaration & INarrativeMedium & IUiMedium;
  ...
  public preview(item: IHeroOriginDeclaration & INarrativeMedium & IUiMedium): void {
