export const SOURCE_DATA_FEED = "source-data-feed";
export const PROGRESSION_DATA_FEED = "progression-data-feed";

export const AREAS_DATA_FEED_KEY = "areas";
export const ACTOR_DATA_FEED_KEY = "actors";
export const QUEST_DATA_FEED_KEY = "quests";
...
export const HERO_ORIGIN_DATA_FEED_KEY = "hero-origin";
...
export const DATA_KEYS = [
  ...
  HERO_ORIGIN_DATA_FEED_KEY,
  HERO_TEMPLATE_DATA_FEED_KEY,
  DUNGEON_TEMPLATES_DATA_FEED_KEY,
  ADVENTURE_TEMPLATE_DATA_FEED_KEY
]