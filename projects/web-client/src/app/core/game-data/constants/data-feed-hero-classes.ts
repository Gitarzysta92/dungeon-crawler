...
export const warrior: IDataContainer<typeof w, INarrationMedium, IUiMedium> = Object.assign(w, {
  narrative: {
...
export const mage: IDataContainer<typeof m, INarrationMedium, IUiMedium> = Object.assign(m, {
  narrative: {
