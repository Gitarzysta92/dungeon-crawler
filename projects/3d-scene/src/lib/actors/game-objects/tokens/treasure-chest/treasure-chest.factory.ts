...
import { chestBodyFirstModel, chestBodyFirstModelFileName, chestBodySecondModel, chestBodySecondModelFileName, chestLidFirstModel, chestLidFirstModelFileName, chestLidSecondModel, chestLidSecondModelFileName, chestTreasureAlphaMap, chestTreasureAlphaMapFileName, chestTreasureModel, chestTreasureModelFileName, treasureChestDefinitionName } from "./treasure-chest.constants";
...
export class TreasureChestFactory extends ActorFactoryBase<ITreasureChestComposerDefinition, TreasureChestObject> {
  ...
  public static async build(
    ...
    const chestBodyFirst = (await assetsLoader.loadAsync(chestBodyFirstModel)).scene.children[0] as Mesh<BufferGeometry, MeshLambertMaterial>;
    ...
    const chestBodySecond = (await assetsLoader.loadAsync(chestBodySecondModel)).scene.children[0] as Mesh<BufferGeometry, MeshLambertMaterial>;
    ...
    const chestLidFirst = (await assetsLoader.loadAsync(chestLidFirstModel)).scene.children[0] as Mesh<BufferGeometry, MeshLambertMaterial>;
    ...
    const chestLidSecond = (await assetsLoader.loadAsync(chestLidSecondModel)).scene.children[0] as Mesh<BufferGeometry, MeshLambertMaterial>;
