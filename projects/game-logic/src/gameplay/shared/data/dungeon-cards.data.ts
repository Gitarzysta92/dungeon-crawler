import { ACTOR_IDENTIFIER, ACTOR_SELECTOR_IDENTIFIER, SOURCE_ACTOR_IDENTIFIER, SPAWN_ACTOR_ACTION_IDENTIFIER } from "../../../lib/modules/actor/actor.constants"
...
import { EFFECT_SELECTOR_IDENTIFIER } from "../../../lib/modules/effect/aspects/selectors/effect.selector"
...
import { MODIFY_STATISTIC_ACTION_IDENTIFIER } from "../../../lib/modules/statistic/statistic.constants"
...
export const makeAttackCard: ICard & IEffectDefinition = {
...
export const increaseEnemyAttackPowerCard: ICard & IEffectDefinition = {
...
export const moveEnemyCard: ICard & IEffectDefinition = {
...
export const spawnCreatureCard: ICard & IEffectDefinition = {
  ...
  castingSchema: {
    ...
    placeOnBoard: {
      ...
      payload: {
        actorId: "{{$.castingSchema.createActor.id}}",
