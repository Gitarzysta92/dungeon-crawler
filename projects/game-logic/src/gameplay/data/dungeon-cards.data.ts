...
import { BOARD_FIELD_IDENTIFIER, BOARD_SELECTOR_IDENTIFIER, MODIFY_POSITION_BY_PATH_ACTION_HANDLER_IDENTIFIER, PATH_IDENTIFIER, PLACE_ON_BOARD_ACTION_HANDLER_IDENTIFIER, ROTATION_IDENTIFIER } from "../../lib/modules/board/board.constants"
