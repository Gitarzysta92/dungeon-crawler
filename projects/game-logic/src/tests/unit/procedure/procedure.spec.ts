...
import { dynamicallyLoadedRecursiveTwoStepProcedureDeclaration, basicTwoStepProcedureDeclaration, basicRecursiveTwoStepProcedureDeclaration, basicSingleStepProcedureDeclaration, basicZeroStepProcedureDeclaration, dynamicallyLoadedRecursiveFourStepProcedureDeclaration, basicTwoStepHorizontalProcedureDeclaration, basicTwoStepProcedureDeclarationWithEarlyResolve } from "./procedure.spec-data";
import { ExecutionOrderProvider, ProcedurePerformerMock, ProcedureTestRecursiveStepMock, ProcedureTestStepMock, compareAggregatedData } from "./procedure.spec-helpers";
...
describe('procedure', () => {
  ...
  it("it should run basicTwoStepProcedureDeclarationWithEarlyResolve and early resolve", async done => {
    ...
    for (let stepKey in procedureDeclaration.procedureSteps) {
      ...
      expect(step.execute.mock.calls).toHaveLength(procedureDeclaration.testMetadata[step.key].numberOfPasses)
    }
