...
export function getEntityFactory(dataFeed: DataFeed) {
  ...
  new AreaModule(dataFeed, lib.entityService, lib.actionService, lib.modifierService, lib.selectorService, lib.eventService, lib.interactionService).initialize();
