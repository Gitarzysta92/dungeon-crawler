...
import { IDungeonPlayerInteractionHandler } from "../../harness/dungeon/dungeon-interaction-handler.interface";
...
export class DungeonPlayerAi implements IDungeonPlayerInteractionHandler {
  ...
  public chooseEffectToCast(state: DungeonGameplay): IEffect {
    return {} as IEffect
  }
